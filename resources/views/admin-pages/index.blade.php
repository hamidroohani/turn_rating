                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{ $times }}</div>
                                <div>تایم های مراجعه</div>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('time') }}">
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{ $clinics }}</div>
                                <div>درمانگاه های فعال</div>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('clinic') }}">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-3">
                                <i class="fa fa fa-heartbeat fa-5x"></i>
                            </div>
                            <div class="col-xs-9 text-right">
                                <div class="huge">{{ $specialties }}</div>
                                <div>تخصص ها</div>
                            </div>
                        </div>
                    </div>
